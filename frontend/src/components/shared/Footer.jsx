...
import img1 from "../../assets/Footer/et.png";
  ...
  return (
    <footer className="">
      <div className="footer lg:container mx-auto  px-4  py-10  lg:px-12  sm:footer-horizontal bg-neutral text-neutral-content items-center  w-full">
        ...
        <nav className=" gap-5 items-center text-center md:justify-self-end  md:text-left w-full md:w-auto">
          {/* Subscribe */}
          <div className="flex flex-col items-center w-full md:items-start">
            ...
            <a
              ...
              className="w-full md:w-64 inline-flex items-center gap-3 px-5 py-3 rounded-lg bg-white/90 text-black font-medium hover:bg-white transition-all duration-300 hover:scale-105 shadow-md border border-transparent hover:border-primary"
            >
              <img
            ...
            {/* Merchandise Button */}
            <a
              href="https://nomadblacksheep.com/merch"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 w-full md:w-64 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-md bg-white/90 hover:bg-white text-black font-medium transition-all duration-300 hover:scale-105 shadow-md"
            >
              🛍️{" "}
              <span className="text-base font-semibold">
                {t("footer.subscribe.merchandise")}
              </span>
            </a>
          </div>
